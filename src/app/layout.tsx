...
export const metadata: Metadata = {
  ...
  description: "Experience unparalleled luxury at Grand Vista Hotel. World-class amenities, exceptional service, and elegant accommodations in the heart of the city.",
  keywords: "luxury hotel, grand vista hotel, premium accommodations, hotel amenities, hospitality, city hotel, spa, fine dining, business travel",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Grand Vista Hotel - Luxury Hospitality Experience",
    description: "Experience unparalleled luxury at Grand Vista Hotel with world-class amenities and exceptional service.",
    siteName: "Grand Vista Hotel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763411271678-5i5ro529.jpg",
  ...
  twitter: {
    ...
    title: "Grand Vista Hotel - Luxury Hospitality Experience",
    description: "Experience unparalleled luxury at Grand Vista Hotel with world-class amenities and exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763411271678-5i5ro529.jpg"]
  }
};
